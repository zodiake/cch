...
public class MemberDetailServiceImpl implements MemberDetailService {
	...
	public Optional<MemberDetail> update(Member member, MemberDetailJson json) {
		return repository.findByMember(member).map(i -> {
			i.setAddress(json.getAddress());
			i.setRealName(json.getRealName());
			return i;
		});
	}
